...
while (Guest.length > 2) {
    var deletedguest = Guest.pop();
    console.log("Sorry Mr. ".concat(deletedguest, ", we apologies your inivitation is pending sorry for inconvience \n\n thank u \n\n "));
}
for (var i = 0; i < Guest.length; i++) {
    // let deletedguest=Guest.pop();
    console.log("Sorry Mr. ".concat(Guest[i], ", we confirm u inivitation despite congested arragment \n\n thank u \n\n "));
}
Guest.splice(0, 2);
console.log(Guest);
